...
//             return Promise.all([
//                 fetch(`${RentalAPI}?event_id=${editEventId}`).then(res => res.json()), // Lấy rental theo event_id
//                 fetch(`${DeviceAPI}`).then(res => res.json()), // Lấy tất cả device để hiển thị
//                 fetch(`${ServiceAPI}`).then(res => res.json()), // Lấy tất cả service để hiển thị
//                 fetch(`${UsersAPI}`).then(res => res.json()) // Lấy tất cả user để hiển thị supplier
...
//                 // Lấy dữ liệu chi tiết liên quan đến rentalId
//                 return Promise.all([
...
//             // Lưu dữ liệu toàn cục để sử dụng trong các hàm khác
//             window.devices = devices;
//             window.services = services;
//             window.users = users;

//             // Xóa các dòng mặc định trong bảng để tránh trùng lặp
...
//                 <option value="${deviceTypeId}">${window.deviceTypes.find(dt => dt.id === deviceTypeId)?.name || "Chọn loại thiết bị"}</option>
//             </select>
//         </td>
//         <td>
//             <select class="form-select" name="devicename">
//                 <option value="${deviceId}">${window.devices.find(d => d.id === deviceId)?.name || "Chọn thiết bị"}</option>
//             </select>
//         </td>
//         <td>
//             <select class="form-select" name="namesuplier">
//                 <option value="${userId}">${window.users.find(u => u.id === userId)?.last_name + " " + window.users.find(u => u.id === userId)?.first_name || "Chọn tên"}</option>
//             </select>
//         </td>
...
//     // Cập nhật danh sách loại thiết bị và thiết bị
...
//                 <option value="${serviceId}">${window.services.find(s => s.id === serviceId)?.name || "Chọn dịch vụ"}</option>
//             </select>
//         </td>
//         <td>
//             <select class="form-select w-auto" name="namesuplier">
//                 <option value="${userId}">${window.users.find(u => u.id === userId)?.last_name + " " + window.users.find(u => u.id === userId)?.first_name || "Chọn tên"}</option>
//             </select>
//         </td>
